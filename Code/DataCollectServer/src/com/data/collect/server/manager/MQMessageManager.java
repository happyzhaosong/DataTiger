...
public class MQMessageManager extends BaseManager implements ExceptionListener {
	...
	public Connection getConnection() throws Exception
	{
		if(connection==null)
		{
			...
			connectionFactory.setSendTimeout(Constants.TIME_OUT_ACTIVEMQ_CLOSE_SECOND_300);
			connectionFactory.setCloseTimeout(Constants.TIME_OUT_ACTIVEMQ_CLOSE_SECOND_300);
	...
	{
		JsonDTO jsonDto = JsonTool.getJsonDtoByObj(Constants.JSON_ROOT_ACTIVE_MQ_MESSAGE, msgDto);
