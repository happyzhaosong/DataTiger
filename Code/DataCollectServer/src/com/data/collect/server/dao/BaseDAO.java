	...
	private void appendWhereBuffer(StringBuffer sqlBuf) throws Exception
	{
		...
		{	
			if(this.getPageDto()!=null)
			{
				...
				{
					this.getPageDto().setFilterOperator(StringTool.isEmpty(this.getPageDto().getFilterOperator(), Constants.EQUAL_MARK));
					...
					if("like".equalsIgnoreCase(this.getPageDto().getFilterOperator()))
					{
						...
						{
							this.getPageDto().setFilterOperator(Constants.EQUAL_MARK);
						}
					}
					...
					}else
					{
						...
						if(StringTool.isEmpty(this.getPageDto().getFilterValue().trim()))
						{
							if(Constants.EQUAL_MARK.equals(this.getPageDto().getFilterOperator()))
							{
								whereBuf.append(" or ");
								whereBuf.append(this.getPageDto().getFilter());
								whereBuf.append(" IS NULL ");
							}else if(Constants.NOT_EQUAL_MARK.equals(this.getPageDto().getFilterOperator()))
							{
								whereBuf.append(" and ");
								whereBuf.append(this.getPageDto().getFilter());
