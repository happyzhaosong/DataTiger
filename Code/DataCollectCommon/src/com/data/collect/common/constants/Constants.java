...
public class Constants extends GeneralConstants{
	...
	//page path
	public static final String PAGE_WEB_SITE = GeneralConstants.PAGE_FOLDER + "/webSite.jsp";
	public static final String PAGE_PARSE_TEMPLATE = GeneralConstants.PAGE_FOLDER + "/parseTemplate.jsp";
	public static final String PAGE_DATA_TABLE = GeneralConstants.PAGE_FOLDER + "/dataTable.jsp";
	...
	//一个操作执行的最小时长，大于这个时长的动作就会被记录到数据库或者日志里面
