...
) ENGINE=MyISAM AUTO_INCREMENT=24773 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='保存互联网抓取的食品信息';
...
) ENGINE=MyISAM AUTO_INCREMENT=47931 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `site_url_parse` (
  ...
  `click_ele_xpath_before_parse_url` text COLLATE utf8_unicode_ci COMMENT 'Click These Web Elements By XPath Before Parse URL (foe parse more element in taobao, tmall, jd etc). All values here should be xpath of elements which need to be clicked before parse url link in this page. Format is urlCharactor1=xpath1,xpath2;urlCharact',
