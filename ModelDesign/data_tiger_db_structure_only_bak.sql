...
/*Table structure for table `data_click_log` */

DROP TABLE IF EXISTS `data_click_log`;

CREATE TABLE `data_click_log` (
  `id` bigint(10) NOT NULL AUTO_INCREMENT,
  `item_url` varchar(2000) COLLATE utf8_bin NOT NULL COMMENT '用户点击的 product item url',
  `click_count` int(10) NOT NULL DEFAULT '0' COMMENT '用户点击的 product 次数',
  `last_click_time` varchar(25) COLLATE utf8_bin NOT NULL COMMENT '用户最后点击的时间 System.currentTimeMillions',
  `search_in` tinyint(4) NOT NULL DEFAULT '0' COMMENT '搜索的范围 0---全部，1---data_xiu_hao_chi, 2---data_xiu_hao_pu',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='记录用户点击产品链接的信息表格，包括点击次数，最后点击时间等';
...
CREATE TABLE `data_search_log_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=57 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='记录用户所有搜索的详细信息，包括关键词，ip，时间，地区，在哪个范围搜索等信息';
...
CREATE TABLE `data_xiu_hao_chi` (
  ...
  `shang_pin_lai_yuan` tinyint(1) NOT NULL DEFAULT '1' COMMENT '商品来源，1---天猫， 2---淘宝， 3---京东，4---当当, 5---我买网',
  ...
  `song_ji_fen` varchar(500) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '本商品送的积分比如天猫商城商品经常送天猫积分',
  `song_ji_fen_num` bigint(10) NOT NULL DEFAULT '-1' COMMENT '本商品送的积分的数字值',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='保存互联网抓取的食品信息';
...
CREATE TABLE `download_task` (
  ...
  `decode_page_url` varchar(2000) COLLATE utf8_bin NOT NULL DEFAULT '""' COMMENT 'Page url decode 之后的值，对于淘宝，天猫，url里面有很多参数是encode的，需要decode后进行判断',
