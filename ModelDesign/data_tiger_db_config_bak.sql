...
insert  into `parse`(`id`,`category_id`,`parse_name`,`parse_desc`,`save_to_table`) values (22,4,'Sina soft download','Sina soft download',NULL),(23,4,'Mac ios app parse template','Mac ios app parse template',NULL),(24,6,'淘宝店铺','解析淘宝店铺信息的模版','data_tao_bao_jie'),(27,6,'淘宝各种食品信息(不包括天猫)','解析淘宝里面的美食特产里面的食品信息(不包括天猫)','data_xiu_hao_chi');
